...
WinObject::WinObject(HWND hwnd, bpd::String classType, bpd::String text, RECT rect) {
...
void WinObject::CreateWnd(HWND hwnd, bpd::String classType, bpd::String text, RECT rect) {
	HWND hwndObject = CreateWindow(
		classType.data, text.data,
		WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON,
		rect.left, rect.top,
...
void WinImage::Load(bpd::String file) {
...
WinText::WinText(HDC hdc, bpd::String Text, RECT Position) {
	pos = {
...
void WinText::Draw(HDC hdc, bpd::String Text, RECT Position) {
